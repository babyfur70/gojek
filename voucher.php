<?php
    echo ("[][][][][][][][][][][][][][][][][][][][][]\n");
        echo ("[]         Suntik Voucher GOJEK         []\n");
        echo ("[]  Creator : SGB TEAM NEW YORK         []\n");
        echo "[]  Version : V2.0                      []\n";
...
if($pass == "1"){
    ...
    sleep(10);
    echo "[+]Process Redeem GOFOOD 20K + 10K\n";
        ...
        $claims = json_decode($claim[0]);
          ...
          echo "\n";
          sleep(10);
          echo "[+]Process Redeem GOFOOD 15K + 10K\n";
        ...
        $claims1 = json_decode($claim1[0]);
          ...
          echo "\n";
          sleep(10);
          echo "[+]Process Redeem GOFOOD 10K x 2 \n";
